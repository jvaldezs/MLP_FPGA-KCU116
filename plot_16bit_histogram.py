...
OUTPUT_IMG = r"C:\Users\jvald\.gemini\antigravity\brain\d7ae2e1b-3951-4b14-9168-71e761676b1f\quantization_16bit_report.png"
...
def generate_report():
    ...
    # ap_fixed<16, 4> parameters:
    # 4 integer bits (including sign)
    # 12 fractional bits
    # Resolution = 2^-12 = 0.0002441406
    # Rounding threshold = 2^-13 = 0.0001220703
    threshold = 2.0 ** -13
    
    print(f"\nAnalysis for ap_fixed<16, 4> (12 fractional bits)")
    ...
    def plot_layer(ax, data, name, rounded_pct, threshold):
        ...
        ax.hist(data_zoom, bins=100, color='skyblue', edgecolor='black', alpha=0.7)
